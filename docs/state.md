# Codebase State
*Updated by Claude Code after each session. Last updated: Mar 2026*

## Routes

| Route | Status | Notes |
|-------|--------|-------|
| `/` | ✅ | Hero: two waitlist CTA cards (lender inline email → `waitlist_submissions`, renter → `/dress-request`) |
...
| `waitlist_submissions` | email, role, created_at |
